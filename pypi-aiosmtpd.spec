...
Source0  : https://files.pythonhosted.org/packages/c4/ca/b2b7cc880403ef24be77383edaadfcf0098f5d7b9ddbf3e2c17ef0a6af0d/aiosmtpd-1.4.6.tar.gz
...
%prep
%setup -q -n aiosmtpd-1.4.6
cd %{_builddir}/aiosmtpd-1.4.6
pushd ..
cp -a aiosmtpd-1.4.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716089331
